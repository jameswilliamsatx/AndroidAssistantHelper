...
/**
 * An object that contains the parsed response from the SpotifyActivity authentication service.
...
public class AuthenticationResponse implements Parcelable {
    ...
    /**
     * Parses the URI returned from the SpotifyActivity accounts service.
     *
     * @param uri URI
