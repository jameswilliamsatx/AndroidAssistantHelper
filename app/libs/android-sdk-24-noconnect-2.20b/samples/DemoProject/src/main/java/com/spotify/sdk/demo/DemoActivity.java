...
public class DemoActivity extends Activity implements
    ...
    private void onAuthenticationComplete(AuthenticationResponse authResponse) {
        ...
        if (mPlayer == null) {
            ...
            // Since the Player is a static singleton owned by the SpotifyActivity class, we pass "this" as
            // the second argument in order to refcount it properly. Note that the method
            // SpotifyActivity.destroyPlayer() also takes an Object argument, which must be the same as the
            // one passed in here. If you pass different instances to SpotifyActivity.getPlayer() and
            // SpotifyActivity.destroyPlayer(), that will definitely result in resource leaks.
    ...
    protected void onPause() {
        ...
        // Note that calling SpotifyActivity.destroyPlayer() will also remove any callbacks on whatever
    ...
    protected void onDestroy() {
        ...
        // For more information, see the documentation on SpotifyActivity.destroyPlayer().
